...
class Settings(BaseSettings):
    ...
    # deploy/docker-compose.yml). Was previously read via a raw
    # `os.environ.get(...)` in db/session.py, bypassing pydantic-settings
    # entirely (docs/best-practices-review.md) -- routed through here so it's
    # validated the same way as every other setting.
